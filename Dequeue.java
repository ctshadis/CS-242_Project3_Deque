...
public class Dequeue<E> extends java.lang.Object {
	 ...
	 * 
	 * @return true Running time O(1) NOT counting time for the reallocate method
	 */
	 ...
	 * fewer element Removes and returns the element in the front of the dequeue
	 * 
	 ...
	 * @throws NoSuchElementException if the dequeue is empty
	 * 
	 * @return the element that was in the rear position of the dequeue Running time
	 * O(n) since it calls size()
	 */
	public E removeRear() {
		if (size() == 0)
			throw new NoSuchElementException();
	...
	/*
	 * Returns the object at the front of the dequeue without removal post: dequeue
	 * unchanged
	 * 
	 * @return the object at the front of the dequeue
	 * 
	 * @throws NoSuchElementException if the dequeue is empty Running time O(n)
	 * since it calls size()
	 */
	public E peekFront() {
		if (size() == 0)
	...
	/*
	 * Returns the object at the rear of the dequeue without removal post: dequeue
	 * unchanged
	 * 
	...
	/*
	 * Checks if there are any elements in the dequeue post: dequeue unchanged
	 * 
	 * @return whether it is empty Running time O(n) since it calls size().
	 */
	 ...
	 * 
	 * @return number of elements in the dequeue Running time O(n)
	 */
	public int size() {
...
//line to verify this is the latest version of the code: 10/26/2019 2:12 PM
